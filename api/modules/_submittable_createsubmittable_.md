...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api/src/submittable/createSubmittable.ts#L17)*
