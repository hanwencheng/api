...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/906732bcdc/packages/api/src/submittable/createSubmittable.ts#L17)*
