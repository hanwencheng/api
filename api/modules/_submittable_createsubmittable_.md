...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api/src/submittable/createSubmittable.ts#L17)*
