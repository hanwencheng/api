...
*Defined in [api/src/submittable/types.ts:27](https://github.com/polkadot-js/api/blob/e2e8e3fedd/packages/api/src/submittable/types.ts#L27)*
...
*Defined in [api/src/submittable/types.ts:32](https://github.com/polkadot-js/api/blob/e2e8e3fedd/packages/api/src/submittable/types.ts#L32)*
