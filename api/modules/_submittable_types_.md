...
*Defined in [submittable/types.ts:27](https://github.com/polkadot-js/api/blob/26b6a59725/packages/api/src/submittable/types.ts#L27)*
...
*Defined in [submittable/types.ts:32](https://github.com/polkadot-js/api/blob/26b6a59725/packages/api/src/submittable/types.ts#L32)*
