...
*Defined in [submittable/Result.ts:11](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L11)*
...
*Defined in [submittable/Result.ts:9](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L9)*
...
*Defined in [submittable/Result.ts:18](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L18)*
...
*Defined in [submittable/Result.ts:22](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L22)*
...
*Defined in [submittable/Result.ts:26](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L26)*
...
*Defined in [submittable/Result.ts:33](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L33)*
...
*Defined in [submittable/Result.ts:42](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/submittable/Result.ts#L42)*
