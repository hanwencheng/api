...
*Defined in [api/src/base/Init.ts:54](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api/src/base/Init.ts#L54)*
...
*Defined in [api/src/base/Init.ts:81](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api/src/base/Init.ts#L81)*
