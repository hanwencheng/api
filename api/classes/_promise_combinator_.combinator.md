...
*Defined in [promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api/src/promise/Combinator.ts#L76)*
