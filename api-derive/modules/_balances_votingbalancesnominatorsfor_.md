...
*Defined in [packages/api-derive/src/balances/votingBalancesNominatorsFor.ts:15](https://github.com/polkadot-js/api/blob/89700f98c5/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L15)*
