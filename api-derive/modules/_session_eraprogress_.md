...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/4cb8462d50/packages/api-derive/src/session/eraProgress.ts#L14)*
