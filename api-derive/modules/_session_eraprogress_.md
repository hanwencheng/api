...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-derive/src/session/eraProgress.ts#L14)*
