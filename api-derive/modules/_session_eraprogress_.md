...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/a695d2a5b5/packages/api-derive/src/session/eraProgress.ts#L14)*
