...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/906732bcdc/packages/api-derive/src/session/eraProgress.ts#L14)*
