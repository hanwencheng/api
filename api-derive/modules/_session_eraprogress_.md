...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/b440c9b0ea/packages/api-derive/src/session/eraProgress.ts#L14)*
