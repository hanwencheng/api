...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/e2e8e3fedd/packages/api-derive/src/session/eraProgress.ts#L14)*
