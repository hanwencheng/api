...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/eade586044/packages/api-derive/src/session/eraLength.ts#L14)*
