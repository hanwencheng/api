...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/4cb8462d50/packages/api-derive/src/session/eraLength.ts#L14)*
