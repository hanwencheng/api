...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/7b37cc79a3/packages/api-derive/src/session/eraLength.ts#L14)*
