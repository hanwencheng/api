...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/e2e8e3fedd/packages/api-derive/src/session/eraLength.ts#L14)*
