...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/8ed2bda3a8/packages/api-derive/src/session/eraLength.ts#L14)*
