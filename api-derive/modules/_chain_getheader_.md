...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/906732bcdc/packages/api-derive/src/chain/getHeader.ts#L30)*
