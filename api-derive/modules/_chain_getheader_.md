...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/89700f98c5/packages/api-derive/src/chain/getHeader.ts#L30)*
