...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/7b37cc79a3/packages/api-derive/src/session/sessionProgress.ts#L14)*
