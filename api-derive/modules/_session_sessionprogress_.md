...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/906732bcdc/packages/api-derive/src/session/sessionProgress.ts#L14)*
