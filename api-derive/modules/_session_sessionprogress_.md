...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/a695d2a5b5/packages/api-derive/src/session/sessionProgress.ts#L14)*
