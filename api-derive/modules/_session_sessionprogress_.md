...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/89700f98c5/packages/api-derive/src/session/sessionProgress.ts#L14)*
