...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/4cb8462d50/packages/api-derive/src/session/sessionProgress.ts#L14)*
