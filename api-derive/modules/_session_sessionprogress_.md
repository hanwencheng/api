...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/8ed2bda3a8/packages/api-derive/src/session/sessionProgress.ts#L14)*
