...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api-derive/src/session/sessionProgress.ts#L14)*
