...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-derive/src/session/sessionProgress.ts#L14)*
