...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/e2e8e3fedd/packages/api-derive/src/session/sessionProgress.ts#L14)*
