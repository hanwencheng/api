...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-derive/src/staking/overview.ts#L18)*
