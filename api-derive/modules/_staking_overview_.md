...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api-derive/src/staking/overview.ts#L18)*
