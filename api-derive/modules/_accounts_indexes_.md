...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/89700f98c5/packages/api-derive/src/accounts/indexes.ts#L33)*
