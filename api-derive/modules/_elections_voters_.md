...
*Defined in [packages/api-derive/src/elections/voters.ts:40](https://github.com/polkadot-js/api/blob/89700f98c5/packages/api-derive/src/elections/voters.ts#L40)*
