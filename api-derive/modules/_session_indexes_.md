...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api-derive/src/session/indexes.ts#L15)*
