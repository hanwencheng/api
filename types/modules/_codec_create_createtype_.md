...
*Defined in [codec/create/createType.ts:74](https://github.com/polkadot-js/api/blob/db59fbff25/packages/types/src/codec/create/createType.ts#L74)*
...
*Defined in [codec/create/createType.ts:60](https://github.com/polkadot-js/api/blob/db59fbff25/packages/types/src/codec/create/createType.ts#L60)*
