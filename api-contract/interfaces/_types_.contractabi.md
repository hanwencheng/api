...
*Defined in [api-contract/src/types.ts:96](https://github.com/polkadot-js/api/blob/7b37cc79a3/packages/api-contract/src/types.ts#L96)*
...
*Defined in [api-contract/src/types.ts:95](https://github.com/polkadot-js/api/blob/7b37cc79a3/packages/api-contract/src/types.ts#L95)*
