...
*Defined in [api-contract/src/types.ts:18](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-contract/src/types.ts#L18)*
...
*Defined in [api-contract/src/types.ts:19](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-contract/src/types.ts#L19)*
...
*Defined in [api-contract/src/types.ts:20](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-contract/src/types.ts#L20)*
...
*Defined in [api-contract/src/types.ts:21](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-contract/src/types.ts#L21)*
...
*Defined in [api-contract/src/types.ts:22](https://github.com/polkadot-js/api/blob/aaff64404a/packages/api-contract/src/types.ts#L22)*
