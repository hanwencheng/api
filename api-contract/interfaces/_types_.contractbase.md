...
*Defined in [types.ts:18](https://github.com/polkadot-js/api/blob/74e20864a6/packages/api-contract/src/types.ts#L18)*
...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/74e20864a6/packages/api-contract/src/types.ts#L19)*
...
*Defined in [types.ts:20](https://github.com/polkadot-js/api/blob/74e20864a6/packages/api-contract/src/types.ts#L20)*
...
*Defined in [types.ts:21](https://github.com/polkadot-js/api/blob/74e20864a6/packages/api-contract/src/types.ts#L21)*
...
*Defined in [types.ts:22](https://github.com/polkadot-js/api/blob/74e20864a6/packages/api-contract/src/types.ts#L22)*
