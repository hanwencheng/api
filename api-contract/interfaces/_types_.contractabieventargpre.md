...
*Defined in [types.ts:115](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api-contract/src/types.ts#L115)*
...
*Defined in [types.ts:31](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api-contract/src/types.ts#L31)*
...
*Defined in [types.ts:32](https://github.com/polkadot-js/api/blob/8b1a7a8584/packages/api-contract/src/types.ts#L32)*
