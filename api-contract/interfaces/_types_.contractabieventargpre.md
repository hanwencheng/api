...
*Defined in [api-contract/src/types.ts:31](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api-contract/src/types.ts#L31)*
...
*Defined in [api-contract/src/types.ts:32](https://github.com/polkadot-js/api/blob/9c337422a5/packages/api-contract/src/types.ts#L32)*
