...
*Defined in [api-contract/src/types.ts:36](https://github.com/polkadot-js/api/blob/7b37cc79a3/packages/api-contract/src/types.ts#L36)*
...
*Defined in [api-contract/src/types.ts:37](https://github.com/polkadot-js/api/blob/7b37cc79a3/packages/api-contract/src/types.ts#L37)*
